...
\label{makereference2.1.3} 

\section{Motorlab}
\label{makereference2.2} 

The Motorlab is a piece of laboratory equipment developed by Dr. Dale Schinstock and Dr. Warren N. White at Kansas State University. It has been in service at the university for over 15 years, and as a result is a time-tested piece of laboratory hardware that has proven to be reliable in terms of providing quality practical control theory application to students enrolled in the class Control of Mechanical Systems I. Because the Motorlab's hardware components were designed and created to insure a very clear translation of laboratory results, in addition to the Motorlab having a much larger operating limit and bandwidth than students use in laboratory practice, this corresponds to a good base model to compare results and the apparatus used in this thesis too.
